...
import test1 from "@/public/testimonials/teams/team-1.jpg";
import test2 from "@/public/testimonials/teams/team-2.jpg";
          ...
          <div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center gap-5 mt-5">
              ...
              <div className="flex flex-col item-center">
                <div className="stars-icon flex items-center gap-1 bg-(--primary) text-white px-3 py-1 rounded-full">
