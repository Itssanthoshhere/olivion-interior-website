        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-2/3">
            <h1 className="CalSans text-5xl md:text-6xl mb-5 w-full lg:w-[60%]">
              Design your <span className="text-(--primary)">space, know</span>{" "}
              services
            </h1>
          </div>
        </div>
          ...
          <div className="w-full lg:w-1/2">
            <div className="pricing-wrap h-full rounded-2xl p-5 pt-20">
              <h1 className="CalSans text-4xl md:text-5xl text-white mb-5 w-full">
                Your dreams,{" "}
                <span className="text-(--primary)">our mission, let's</span>{" "}
                make it happen.
              </h1>
            </div>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              {PricingPlansData.map((plan, index) => (
                ...
                >
                  ...
                  <h1 className="text-6xl lg:text-7xl mt-5 text-(--primary) CalSans flex border-b border-gray-300 pb-3">
                    {plan.price}{" "}
                  ...
                  <button className="border border-gray-300 GolosText rounded-full px-4 py-2 hover:bg-(--primary) hover:text-white cursor-pointer hover:border-transparent transition-all duration-300">
                    Get Started Now
                  </button>
                </div>
              ))}
