...
import service1 from "@/public/services/service-1.jpg";
import service2 from "@/public/services/service-2.jpg";
        ...
        <div className="flex flex-col md:flex-row w-full md:w-[70%] gap-2 md:gap-8">
          ...
          <div className="service-content">
            ...
            <p className="GolosText text-gray-400">
              Tailored design services for private homes, including stylish room
              makeovers, complete home transformations, and personalized décor
              planning — creating comfortable, functional, and visually stunning
              living spaces that reflect each client’s unique taste and
              lifestyle.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row w-full md:w-[70%] gap-2 md:gap-8">
          ...
          <div className="service-content">
            ...
            <p className="GolosText text-gray-400">
              ...
              improve productivity, and create inspiring environments that leave
        ...
        <div className="flex flex-col md:flex-row w-full md:w-[70%] gap-2 md:gap-8">
          ...
          <div className="service-content">
            ...
            <p className="GolosText text-gray-400">
              ...
              material selection — helping clients make informed design choices
              that balance aesthetics and functionality while ensuring each
              space reflects their personal vision, style, and desired
              atmosphere.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row w-full md:w-[70%] gap-2 md:gap-8">
          ...
          <div className="service-content">
            ...
            <p className="GolosText text-gray-400">
              ...
              patios, and decks — creating harmonious, functional, and visually
              appealing environments that seamlessly connect indoor and outdoor
              living
            </p>
          </div>
        </div>
      ...
      <div className="service-card border-b border-gray-400 cursor-pointer py-2 flex flex-col md:flex-row justify-between items-start md:items-center gap-5">
        <div className="flex flex-col md:flex-row w-full md:w-[70%] gap-2 md:gap-8">
          ...
          <div className="service-content">
            ...
            <p className="GolosText text-gray-400">
              Overhauling existing spaces to modernize and improve functionality
              and aesthetics — transforming outdated interiors into stylish,
              efficient, and inviting environments that align with contemporary
              design trends and enhance everyday living experiences.
            </p>
          </div>
        </div>
